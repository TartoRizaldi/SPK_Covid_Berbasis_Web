...
<html><head>
    ...
    <base href="http://localhost/SPKCovid/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <b><img src="gambar/WhatsApp-Image-2021-11-21-at-16.05.47.png" width="50" height="43">SISTEM PAKAR</b></span>
        </a>
        <!-- Header Navbar -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2021 - Made by Irfan</div></strong>
      </footer>
