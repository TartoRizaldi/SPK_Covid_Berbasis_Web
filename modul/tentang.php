...
<head>
  <meta charset="UTF-8">
   <title>Tentang - SPK Covid-19</title>
...
<button style="margin-bottom: 10px;" type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Pengembang"><i class="fa fa-user-md" aria-hidden="true"></i> Irfan</button></a>
	 </p>
	   <br>
	   <h2 class="f5 silver mt2 mb1">&nbsp;</h2>
	  <h2 class="f5 silver mt2 mb1">Copyright © 2020, <a class="link dim silver">by Irfan</a></h2>
	  <br>
    ...
    <p class="f6 tl lh-copy silver" style="margin: 20px;">Sistem pakar yang mampu mendiagnosa penyakit Covid-19 berdasarkan pengetahuan yang diberikan langsung dari pakar/ahlinya dan melalui studi  literatur. Penelitian ini menggunakan metode perhitungan Certainty Factor (CF) dalam menghitung tingkat kepakaran. Data penelitian ini terdiri dari data gejala dan data Covid-19 serta data aturan. Sistem pakar pada organisasi ditujukan  untuk penambahan  value, peningkatan produktivitas serta area manajerial yang dapat mengambil kesimpulan dengan cepat.</p>
  </article>
</div>
</body>
